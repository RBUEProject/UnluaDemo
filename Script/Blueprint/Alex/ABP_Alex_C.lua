...
local ABP_Alex_C = Class()

--function ABP_Alex_C:Initialize(Initializer)
--end

--function ABP_Alex_C:BlueprintInitializeAnimation()
--end

function ABP_Alex_C:BlueprintBeginPlay()
...
function ABP_Alex_C:BlueprintUpdateAnimation(DeltaTimeX)
...
-- function ABP_Alex_C:BlueprintPostEvaluateAnimation()
-- end
