...
local ABP_Swat_C = Class()

--function ABP_Swat_C:Initialize(Initializer)
--end

--function ABP_Swat_C:BlueprintInitializeAnimation()
--end

function ABP_Swat_C:BlueprintBeginPlay()
...
function ABP_Swat_C:BlueprintUpdateAnimation(DeltaTimeX)
...
-- function ABP_Swat_C:BlueprintPostEvaluateAnimation()
-- end
